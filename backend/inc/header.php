<?php
@session_start();
// Always include the unified connection file from backend root
// This is robust to working directory changes and deploy environments
$connPath = realpath(__DIR__ . '/../conexao.php');
