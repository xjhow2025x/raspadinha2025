...
try {
    ...
    logDebug("Dados do PIX decodificados", $pixData);

    if (!isset($pixData['id'], $pixData['pixCode'])) {
        logDebug("Erro: Resposta inválida da API", $pixData);
    ...
    logDebug("ERRO CAPTURADO", ['message' => $e->getMessage(), 'trace' => $e->getTraceAsString()]);
